...
const BAR_THEME: Record<BarId, { label: string; cls: string }> = {
  morale: { label: 'MORALE', cls: 'gb-gold' },
  army: { label: 'ARMY', cls: 'gb-blue' },
  enemy: { label: 'ENEMY', cls: 'gb-red' },
}
  ...
  return (
    <div className="gb-row">
      ...
      <div className={`gb-frame ${t.cls}`}>
        ...
        <i className="gb-rivet gb-tl" /><i className="gb-rivet gb-tr" /><i className="gb-rivet gb-bl" /><i className="gb-rivet gb-br" />
      </div>
